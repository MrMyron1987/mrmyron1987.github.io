...
const translations = {
    sv: {
        ...
        skogligaJobbDesc: "Sveriges samlingsplats för lediga jobb inom skogsbranschen.",
        ...
        sveaskogDesc: "Sveriges statliga skogsbolag. Förvaltar och brukar skogsmark, levererar timmer, massaved och biobränsle. Verksamt i Sverige.",
        upmTitle: "UPM",
        ...
        sodraTitle: "Södra",
        sodraDesc: "Sveriges största skogsägarförening med över 50 000 medlemmar.",
        sodraskogsTitle: "Södra skogsreviret",
        sodraskogsDesc: "Regionalt skogsrevir i södra Finland med fokus på skoglig rådgivning och virkesanskaffning.",
        osterbottenTitle: "Österbotten skogsrevir",
        osterbottenDesc: "Regionalt skogsrevir i Österbotten, Finland med fokus på skoglig rådgivning och virkesanskaffning.",
        skogssallskapetTitle: "Skogssällskapet",
        skogssallskapetDesc: "Svensk skogsorganisation som erbjuder tjänster inom skogsförvaltning, rådgivning och fastighetsutveckling. Verksam i Sverige och Finland",
        mellanskogTitle: "Mellanskog",
        mellanskogDesc: "Skogsägarförening i Mellansverige. Erbjuder tjänster inom virkesförsäljning och skogsvård.",
        ...
        sveaskogTitle: "Sveaskog",
        sveaskogDesc: "Ruotsin valtion metsäyhtiö. Hoitaa ja käyttää metsämaata, toimittaa puutavaraa, kuitupuuta ja biopolttoainetta. Toimii Ruotsissa.",
        upmTitle: "UPM",
        ...
        sodraTitle: "Södra",
        sodraDesc: "Ruotsin suurin metsänomistajien osuuskunta, jossa on yli 50 000 jäsentä. Tarjoaa uramahdollisuuksia metsätaloudessa.",
        sodraskogsTitle: "Södra skogsreviret",
        sodraskogsDesc: "Metsätalousneuvontaan ja puunhankintaan keskittyvä alueellinen metsäpiiri Etelä-Suomessa.",
        osterbottenTitle: "Pohjanmaan metsäpiiri",
        osterbottenDesc: "Metsätalousneuvontaan ja puunhankintaan keskittyvä alueellinen metsäpiiri Pohjanmaalla.",
        skogssallskapetTitle: "Skogsällskapet",
        skogssallskapetDesc: "Ruotsalainen metsätalousorganisaatio, joka tarjoaa palveluita metsänhoidon, konsultoinnin ja kiinteistökehityksen aloilla. Toimii Ruotsissa ja Suomessa",
        mellanskogTitle: "Mellanskog",
        mellanskogDesc: "Metsänomistajayhdistys Keski-Ruotsissa. Tarjoaa palveluita puun myynnissä ja metsänhoidossa.",
    ...
    en: {
        ...
        sveaskogTitle: "Sveaskog",
        sveaskogDesc: "Sweden's state forest company. Manages and cultivates forest land, delivers timber, pulpwood and biofuel. Operates in Sweden.",
        upmTitle: "UPM",
        ...
        sodraTitle: "Södra",
        sodraDesc: "Sweden's largest forest owner association with over 50,000 members.",
        sodraskogsTitle: "Södra skogsreviret",
        sodraskogsDesc: "Regional forest district in southern Finland with a focus on forestry advice and timber procurement.",
        osterbottenTitle: "Österbotten skogsrevir",
        osterbottenDesc: "Regional forest district in Ostrobothnia, Finland with a focus on forestry advice and timber procurement.",
        skogssallskapetTitle: "Skogsällskapet",
        skogssallskapetDesc: "Swedish forestry organization that offers services within forest management, consulting and property development. Operating in Sweden and Finland",
        mellanskogTitle: "Mellanskog",
        mellanskogDesc: "Forest owner association in central Sweden. Offers services in timber sales and forest care",
